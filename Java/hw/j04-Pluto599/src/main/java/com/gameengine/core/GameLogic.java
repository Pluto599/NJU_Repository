...
public class GameLogic {
    ...
    public void checkCollisions() {
        ...
        if (currentTime - lastPrintTime >= 3000) {
            if (frameCount > 0) {
                double avgPhysicsMs = totalPhysicsTime / 1_000_000.0 / frameCount;
                double avgCollisionMs = totalCollisionTime / 1_000_000.0 / frameCount;
                double avgTotalMs = avgPhysicsMs + avgCollisionMs;
